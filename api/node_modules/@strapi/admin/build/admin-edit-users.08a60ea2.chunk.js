...
`,K=()=>t.createElement(T,null,t.createElement(c.Loader,null)),S=async()=>{const{get:f}=(0,v.getFetchClient)(),{data:h}=await f("/admin/roles");return h.data},s=({disabled:f,error:h,onChange:F,value:G})=>{const{status:Q,data:H}=(0,o.useQuery)(["roles"],S,{staleTime:5e4}),{formatMessage:C}=(0,g.useIntl)(),Y=h?C({id:h,defaultMessage:h}):"",j=C({id:"app.components.Users.ModalCreateBody.block-title.roles",defaultMessage:"User's roles"}),z=C({id:"app.components.Users.ModalCreateBody.block-title.roles.description",defaultMessage:"A user can have one or several roles"}),$=C({id:"app.components.Select.placeholder",defaultMessage:"Select"}),k=Q==="loading"?t.createElement(K,null):void 0;return t.createElement(l.Select,{id:"roles",disabled:f,error:Y,hint:z,label:j,name:"roles",onChange:A=>{F({target:{name:"roles",value:A}})},placeholder:$,multi:!0,startIcon:k,value:G,withTags:!0,required:!0},(H||[]).map(A=>t.createElement(l.Option,{key:A.id,value:A.id},C({id:`global.${A.code}`,defaultMessage:A.name}))))};s.defaultProps={disabled:!1,error:void 0},s.propTypes={disabled:n().bool,error:n().string,onChange:n().func.isRequired,value:n().array.isRequired},u.Z=s},1057:function(R,u,e){e.d(u,{YM:function(){return m},Rw:function(){return l}});var t=e(5173),a=e(13478);const n={firstname:t.Z_().trim().required(a.translatedErrors.required),lastname:t.Z_(),email:t.Z_().email(a.translatedErrors.email).lowercase().required(a.translatedErrors.required),username:t.Z_().nullable(),password:t.Z_().min(8,a.translatedErrors.minLength).matches(/[a-z]/,"components.Input.error.contain.lowercase").matches(/[A-Z]/,"components.Input.error.contain.uppercase").matches(/\d/,"components.Input.error.contain.number"),confirmPassword:t.Z_().min(8,a.translatedErrors.minLength).oneOf([t.iH("password"),null],"components.Input.error.password.noMatch").when("password",(c,P)=>c?P.required(a.translatedErrors.required):P)};var l={...n,currentPassword:t.Z_().when(["password","confirmPassword"],(c,P,v)=>c||P?v.required(a.translatedErrors.required):v),preferedLanguage:t.Z_().nullable()},o={roles:t.IX().min(1,a.translatedErrors.required).required(a.translatedErrors.required)},m=t.Ry().shape({...n,isActive:t.Xg(),...o})},28890:function(R,u,e){var t=e(32735),a=e(5636),n=e(60216),g=e.n(n),l=e(463),d=e(76779);const o=({registrationToken:p})=>{const{formatMessage:m}=(0,a.useIntl)();return p?t.createElement(d.Z,{target:`${window.location.origin}${l.Z}auth/register?registrationToken=${p}`},m({id:"app.components.Users.MagicLink.connect",defaultMessage:"Copy and share this link to give access to this user"})):t.createElement(d.Z,{target:`${window.location.origin}${l.Z}auth/login`},m({id:"app.components.Users.MagicLink.connect.sso",defaultMessage:"Send this link to the user, the first login can be made via a SSO provider."}))};o.defaultProps={registrationToken:""},o.propTypes={registrationToken:g().string},u.Z=o}}]);
